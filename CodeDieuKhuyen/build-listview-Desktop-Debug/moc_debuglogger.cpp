...
#include <memory>
#include "../listview/debuglogger.h"
...
QT_MOC_LITERAL(1, 12, 8), // "logAdded"
QT_MOC_LITERAL(2, 21, 0) // ""

    },
    "DebugLogger\0logAdded\0"
};
...
void DebugLogger::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (DebugLogger::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&DebugLogger::logAdded)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject DebugLogger::staticMetaObject = { {
    QMetaObject::SuperData::link<QObject::staticMetaObject>(),
    qt_meta_stringdata_DebugLogger.data,
    qt_meta_data_DebugLogger,
    qt_static_metacall,
    nullptr,
    nullptr
} };
